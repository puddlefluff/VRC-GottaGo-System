...
The current bladder fill volume as a percentage of 600ml (hold volume radial set to 100%).
...
The total volume released as a percentage of 600ml (hold volume radial set to 100%).
...
The current bowels fill volume as a percentage of the maximum possible configurable amount (hold volume radial set to
100%).
...
The total volume released as a percentage of the maximum possible configurable amount (hold volume radial set to 100%).
